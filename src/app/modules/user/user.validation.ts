...
export const createUserZodSchema = z.object({
  ...
  password: z.string({ invalid_type_error: "Password must be string" }).min(6, { message: "Password must be at least 6 characters long." }),
  // .regex(/^(?=.*[A-Z])/, {
...
export const updateUserZodSchema = z.object({
  ...
  phone: z.string({ invalid_type_error: "Phone Number must be string" }).optional(),
  role: z

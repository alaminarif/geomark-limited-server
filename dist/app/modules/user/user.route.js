...
router.post("/register", (0, validateRequest_1.validateRequest)(user_validation_1.createUserZodSchema), multer_config_1.multerUpload.single("file"), user_controller_1.UserControllers.createUser);
